...
pyspedas.mms.eis(probe=3, datatype='phxtof', trange=['2018-5-18/13:50','2018-5-18/14:10'],time_clip=True)
...
PVI = abs(avg[0:])
array7 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t5'].data[:, 6]
array6 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t5'].data[:, 5]
array5 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t5'].data[:, 4]
array4 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t5'].data[:, 3]
array3 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t5'].data[:, 2]
array2 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t5'].data[:, 1]
array1 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t5'].data[:, 0]

array14 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t4'].data[:, 6]
array13 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t4'].data[:, 5]
array12 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t4'].data[:, 4]
array11 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t4'].data[:, 3]
array10 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t4'].data[:, 2]
array9 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t4'].data[:, 1]
array8 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t4'].data[:, 0]

array21 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t3'].data[:, 6]
array20 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t3'].data[:, 5]
array19 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t3'].data[:, 4]
array18 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t3'].data[:, 3]
array17 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t3'].data[:, 2]
array16 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t3'].data[:, 1]
array15 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t3'].data[:, 0]

array28 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t2'].data[:, 6]
array27 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t2'].data[:, 5]
array26 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t2'].data[:, 4]
array25 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t2'].data[:, 3]
array24 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t2'].data[:, 2]
array23 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t2'].data[:, 1]
array22 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t2'].data[:, 0]

array35 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t1'].data[:, 6]
array34 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t1'].data[:, 5]
array33 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t1'].data[:, 4]
array32 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t1'].data[:, 3]
array31 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t1'].data[:, 2]
array30 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t1'].data[:, 1]
array29 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t1'].data[:, 0]

array42 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t0'].data[:, 6]
array41 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t0'].data[:, 5]
array40 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t0'].data[:, 4]
array39 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t0'].data[:, 3]
array38 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t0'].data[:, 2]
array37 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t0'].data[:, 1]
array36 = data2['mms3_epd_eis_srvy_l2_phxtof_proton_P4_flux_t0'].data[:, 0]
...
mms_eis_pad(probe=3, datatype='phxtof')
